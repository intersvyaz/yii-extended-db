...
use CDbTableSchema;
use CException;
use CPgsqlColumnSchema;
use CPgsqlCommandBuilder;
use CPgsqlTableSchema;

/**
 * IsPgsqlSchema is the class for retrieving metadata information from a PostgreSQL database.
 * From Postgres version >= 12
 * @see \CPgsqlSchema
 */
class PgsqlSchema extends CDbSchema
{
...
EOD;
        ...
        foreach ($columns as $column) {
            ...
            if (
                stripos($column['adsrc'], 'nextval') === 0
     ...
     * @return CPgsqlColumnSchema normalized column metadata
     */
